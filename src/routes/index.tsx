...
function HomePage() {
  return (
    <div className="mx-auto w-full max-w-305 px-4 md:px-5">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <article className="feature-card rounded-xl border border-(--line) p-5">
            ...
            <p className="mt-2 text-sm text-(--sea-ink-soft)">
              ...
              рядків, адаптивних мобільних макетів, липких заголовків, UI-станів
              і сценарію вибору дати на мобільних пристроях.
            </p>
            <Link
          ...
          <article className="feature-card rounded-xl border border-(--line) p-5">
            ...
            <p className="mt-2 text-sm text-(--sea-ink-soft)">
              Окремий розділ із двома демо: клієнтська фільтрація та
              URL-керована серверна фільтрація поверх того самого датасету.
            </p>
